        ...
        <>
            <div className="  text-center rounded-lg text-white font-bold">
                <button
                    type="button"
                    onClick={openModal}
                    className="w-full  bg-rose-300 py-2 text-center rounded-lg  hover:bg-rose-400 text-gray-50 font-bold "
                >
                    Buy Now
                </button>
            </div>
                                        ...
                                        <div className="flex flex-col items-center justify-center py-8 mx-auto  lg:py-0">
                                            ...
                                            <div className="w-full  rounded-lg md:mt-0 sm:max-w-md xl:p-0 ">
                                                ...
                                                <form className="space-y-4 md:space-y-6" action="#">
                                                    ...
                                                    <button onClick={()=>{buyNow(); closeModal()}} type="button" className="focus:outline-none w-full text-gray-50 bg-rose-300 hover:bg-rose-400  outline-0 font-medium rounded-lg text-sm px-5 py-2.5 ">Order Now</button>
